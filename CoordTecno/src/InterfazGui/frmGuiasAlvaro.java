 ...
 * @author CoordTecno
 */
public class frmGuiasAlvaro extends JDialog {
     ...
     */
    public frmGuiasAlvaro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setTitle("Imprimir Guias");
        setResizable(false);
   ...
   try{     
    ...
    if(control.isEmpty()==true && planilla.isEmpty()==true ){
        ...
        str="or Num_PlanillaRpto="+planilla+" and e.Cod_Regional=83";
        }else{
         str="or Num_ControlC="+control+" and e.Cod_Regional=83 "; 
    }

///*     */ 
             frmGuiasAlvaro.this.guia = new ConsultaGuia();
/* 123 */   frmGuiasAlvaro.this.resGuias = frmGuiasAlvaro.this.guia.ConsDatosGuia(str);
/*     */ 
/*     */     
...
/*     */     }
   ...
   try{     
    ...
    if(control.isEmpty()==true && planilla.isEmpty()==true ){
        JOptionPane.showMessageDialog(null, "Por favor coloque un numero de control de cargue o de pplanilla de reparto.");
        dispose();
    }if(control.isEmpty()==true) {
...
/*     */     }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmGuiasAlvaro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmGuiasAlvaro dialog = new frmGuiasAlvaro(new javax.swing.JFrame(), true);
